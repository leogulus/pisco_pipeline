...
if __name__ == "__main__":
    ...
    total=pd.read_csv("/Users/taweewat/Documents/pisco_code/slr_output/total_%s.csv"%field)
    ...
    total3=Table.from_pandas(pd.read_csv("/Users/taweewat/Documents/pisco_code/slr_output/star_total_%s.csv"%field))
    total3=total3[['NUMBER','ALPHA_J2000_i','DELTA_J2000_i','MAG_AUTO_i','MAGERR_AUTO_i','MAG_AUTO_g','MAGERR_AUTO_g',\
                  'MAG_AUTO_r','MAGERR_AUTO_r','MAG_AUTO_z','MAGERR_AUTO_z','CLASS_STAR_i','CLASS_STAR_g',\
                  'CLASS_STAR_r','CLASS_STAR_z','FLAGS_i','FLAGS_g','FLAGS_r','FLAGS_z']]
    ...
    print 'total number of objects', len(total3)
    ...
    total_gal=Table.from_pandas(pd.read_csv("/Users/taweewat/Documents/pisco_code/slr_output/galaxy_total_%s.csv"%field))
    ntotal_gal = update_color(slrdir+'/star_%s.fits.offsets.list'%field, total_gal)
    ntotal_gal.write(os.path.join(slrdir, 'galaxy_ntotal_%s.csv' % field), overwrite=True)
