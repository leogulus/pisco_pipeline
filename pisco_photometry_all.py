...
def sur_pro_prob_ang(r,rc):
    return sur_pro(r,rc)/sur_pro(0.1,rc)
...
def pisco_tilt_resequence(field, mode='psf', mode2mass=''):
        ...
        for z in bins_rmi_cen:
            ...
            if row['MAG_i'] < Mag_cut:
                ...
                if (rmi > low_edge) & (rmi <= high_edge):
                    ...
                    wrmi0=sur_pro_prob_ang(row['sep(deg)']*60, core_radius); w_rmi.append(wrmi0) #arcmin
        ...
        for z in bins_gmr_cen:
            ...
            if row['MAG_i'] < Mag_cut:
                ...
                if (gmr > low_edge) & (gmr <= high_edge):
                    ...
                    wgmr0 = sur_pro_prob_ang(row['sep(deg)'] * 60, core_radius); w_gmr.append(wgmr0)  # arcmin
                    dfi.loc[i,"z_gmr"]=z
    ...
    dense_fn = lambda z: integrate.quad(NFW_profile,0.001,core_radius*cosmo.kpc_proper_per_arcmin(z).value/1e3)[0]
...
if __name__ == "__main__":
    ...
    # all_fields = ['CHIPS2317-1443']
    # all_fields = ['CHIPS2245-4931','CHIPS0040-2902','CHIPS0025-5427','CHIPS2311-4718','CHIPS0150-3338','CHIPS0335-4715','CHIPS0022-5140','CHIPS0512-3257','CHIPS0514-5046','CHIPS0535-6602','CHIPS0050-5249','CHIPS0133-4358','CHIPS2228-3220','CHIPS2306-3439','CHIPS0004-4736','CHIPS0024-6820','CHIPS2303-6807','CHIPS0342-3703','CHIPS0146-3648','CHIPS1011-0505','CHIPS2148-3715','CHIPS0253-5441','CHIPS0745-0714','CHIPS0206-7148','CHIPS0018-1840','CHIPS0122-2646']
    # all_fields= ['Field039','Field037','Field115','Field059','Field292','Field074','Field077','Field076','Field212','Field018','Field105','Field046','Field088','Field269','Field084','Field085','Field266','Field087','Field029','Field225','Field226','Field022']
    # Field063 (130)
    ...
    # all_fields=['CHIPS0106-1149','CHIPS0107-1310','CHIPS0132-1608','CHIPS2340-2302','CHIPS0018-1840','CHIPS2349-2352','CHIPS0118-1430','CHIPS0116-1136','CHIPS0140-1533','CHIPS2357-1125','CHIPS0003-2521','CHIPS0050-1412','CHIPS0122-2646','CHIPS2333-2407','CHIPS2317-1443','CHIPS0015-1513','CHIPS0106-2358','CHIPS0137-1248']
